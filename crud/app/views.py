...
def make_men():
    p, _ = Person.objects.get_or_create(name='Jessus', surname='Christos ',
                                        age=2023,
                                        gender=True)
    p, _ = Person.objects.get_or_create(name='Tom', surname='Mikheev', age=16,
                                        gender=True)
    p, _ = Person.objects.get_or_create(name='Nastia', surname='Rudko', age=23,
                                        gender=False)
    p, _ = Person.objects.get_or_create(name='Danil', surname='Titov', age=17,
                                        gender=True)
